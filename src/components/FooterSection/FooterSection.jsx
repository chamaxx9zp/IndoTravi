    ...
    <footer className="bg-black text-gray-400 py-16">
      <div className="max-w-7xl mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-2">
          ...
          <div className='md:pl-30 justify-start md:justify-center'>
            <h3 className="text-white text-xl font-semibold mb-6">
              Newsletter
            </h3>
            <p className="mb-6">
            ...
            <form
              ...
              className="flex gap-2 border rounded-full border-gray-700 p-1"
            >
            ...
            <div className="flex gap-4 mt-8 md:justify-end justify-center">
